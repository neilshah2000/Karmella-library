...
SECRET_KEY = '(7i)p%)ud1tymry!75(&+sj*%sht%=z%8@@11almo4cybwhgfx'
...
STATICFILES_DIRS = (os.path.join(BASE_DIR, 'public'),) # should contain paths to your project's static files
